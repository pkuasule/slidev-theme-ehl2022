    ...
    <div class="my-auto">
      ...
      <div class="grid grid-cols-2 gap-6">
        <div class="flex flex-col items-left">
          <img class="w-full h-screen-30 object-cover object-center mt-4 bg-shade" :src="pic1">
          <slot name="C1" />
        </div>
        <div class="flex flex-col items-left">
          <img class="w-full h-screen-30 object-cover object-center mt-4 bg-shade" :src="pic2">
          <slot name="C2" />
        </div>
      </div>
      <footer 
